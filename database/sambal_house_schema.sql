...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2026 at 06:05 PM
...
CREATE TABLE `orders` (
  ...
  `country` varchar(120) NOT NULL DEFAULT 'Malaysia',
  `payment_method` varchar(50) NOT NULL DEFAULT 'COD',
  `status` enum('PENDING','PAID','PROCESSING','SHIPPED','RECEIVED','COMPLETED','CANCELLED','RETURNED') NOT NULL DEFAULT 'PENDING',
  ...
  `cancellation_accepted_at` datetime DEFAULT NULL,
  `refunded_at` datetime DEFAULT NULL,
  `return_requested_at` datetime DEFAULT NULL,
  `return_accepted_at` datetime DEFAULT NULL,
  `return_refunded_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `products` (
  ...
  `origin_location` varchar(120) DEFAULT NULL,
...
CREATE TABLE `user_activity` (
  `user_id` int(11) NOT NULL,
  `user_name` varchar(100) DEFAULT NULL,
  `current_action` varchar(150) DEFAULT NULL,
